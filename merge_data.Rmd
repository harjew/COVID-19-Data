...
get_covid_uk <- function(level = 1){
  link_uk <- "https://www.ons.gov.uk/file?uri=/peoplepopulationandcommunity/birthsdeathsandmarriages/deaths/datasets/weeklyprovisionalfiguresondeathsregisteredinenglandandwales/2021/publishedweek032021replacement.xlsx"
...
Have not found any online sources for Germany for age and gender

```{r}

#germany <- merge_globalheath_covid19dh(country = "Germany")
...
```{r}
write.csv2(belgium1, "covid-data/COVID-19-SWITZERLAND-level-1.csv")
write.csv2(belgium2, "covid-data/COVID-19-SWITZERLAND-level-2.csv")
